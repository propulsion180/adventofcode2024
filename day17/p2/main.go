...
func main() {
	...
	// initial := runOpsOnRegs(regA, regB, regC, ops)
	...
	for i := 1; i < math.MaxInt64; i++ {
		...
		curr := runOpsOnRegs(i, regB, regC, ops)

		if curr == targetOutput {
			fmt.Println("Found the correct value for Register A:", i)
			fmt.Println("Program Output:", curr)
